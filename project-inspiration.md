...
## 📊 Portfolios Analizados: Patrones Transferibles

### Referencias Analizadas (Feb 2026)

1. **[Martin Campos](https://www.martin-campos.com/)** - Pintor/Ilustrador
   - Enfoque: Minimalismo + Obra como protagonista
   
2. **[La Tatuajería Tattoo Studio](https://www.latatuajeria.com/)** - Estudio de diseño creativo
   - Enfoque: Brutalismo urbano + Experiencia inmersiva
   
3. **[Veta Galería - Matías Sánchez](https://vetagaleria.com/es/artists/44-matias-sanchez/)** - Galería profesional
   - Enfoque: Contexto profesional + Accesibilidad institucional

### 🎯 Patrones Transferibles (Sin Copiar)

#### Patrón 1: Secciones Temáticas vs Cronológicas
**Origen:** Martin Campos (organización por técnica: Pastels, Paintings, Landscapes, Oil Sketches)

**Insight:** Categorizar por tipo de proyecto (técnica, serie temática, medio) mejora exploración vs timeline cronológico que abruma.

**Aplicación a tu proyecto:** En lugar de "Todos los proyectos por fecha", crear secciones como:
- Ilustración Editorial
- Identidad Visual
- Experimentos Tipográficos
→ Usuario entiende contexto al entrar a sección; exploración más intuitiva

---

#### Patrón 2: Minimalismo Estratégico + Contexto Expandible
**Origen:** Martin Campos (limpieza visual) × Veta Galería (metadatos)

**Insight:** Balance entre estética limpia (deja respirar al contenido) y suficiente contexto (título, año, técnica) sin saturar.

**Aplicación a tu proyecto:** 
- En grid: mostrar imagen + título + año (mínimo visual)
- En detail/modal: expandir con descripción, proceso, tags técnicos
→ Mobile-friendly + desktop-rich, escalable según interés usuario

---

#### Patrón 3: Accesibilidad como Estándar (no afterthought)
**Origen:** Veta Galería (contraste alto, tipografía clara, estructura semántica)

**Insight:** Altos contrastes, tipografía sin serifs, espacios en blanco deliberados = accesible para todos, no solo personas con discapacidad.

**Aplicación a tu proyecto:**
- Respetar `--color-text-primary: #0f172a` + `--color-bg: #ffffff` (contraste 15.8:1 WCAG AAA)
- Usar `--font-family-base: system-ui` para legibilidad
- Espacios generosos entre elementos (usar `--space-*` tokens)
→ Inclusividad + profesionalismo percibido
